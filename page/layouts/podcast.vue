<template>
  <!-- No Appbar and no site Footer on purpose: the show reads as its own
  ...
  <div class="podcast-page">
    <slot />
    <!-- The language switch, on every podcast page. Here in the layout, not
      the pages, so it stays on screen while the page swipes to the other
